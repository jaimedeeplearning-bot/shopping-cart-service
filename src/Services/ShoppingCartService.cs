...
namespace ShoppingCartService.Services
{
    ...
    public class ShoppingCartService
    {
        ...
        public void AddProduct(Product product, int quantity = 1)
        {
            ...
            if (product.Price < 0)
                throw new ArgumentException("El precio del producto no puede ser negativo", nameof(product));
        ...
        public async Task<bool> ApplyDiscountCodeAsync(string code)
        {
            ...
            if (discountCode.DiscountPercentage < 0 || discountCode.DiscountPercentage > 100)
                throw new ArgumentException("El porcentaje de descuento debe estar entre 0 y 100", nameof(code));
        ...
        public void SetTaxRate(decimal rate)
        {
            ...
            if (rate > 100)
                throw new ArgumentException("La tasa de impuesto no puede ser mayor a 100%", nameof(rate));
